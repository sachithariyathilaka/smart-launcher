...
public class SettingsActivity extends AppCompatActivity implements ClickListenerService {
    ...
    List<AppPackage> disabledApps = new ArrayList<>();
    ...
    private void openAddDisableAppsAlert() {
        ...
        Objects.requireNonNull(disableApps.getWindow()).setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
